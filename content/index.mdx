...
metaDescription: "Learn how to use unit tests and end to end tests (e2e) with WordPress Scripts (@wordpress/scripts) and create-react-app"
---
...
In general, this content is designed to be useful for WordPress developers who are learning React and how to use it in the new "Gutenberg" post editor. I am [making some specific assumptions](https://react-wordpress-testing.joshpress.net/introduction#assumptionsaboutyou).
