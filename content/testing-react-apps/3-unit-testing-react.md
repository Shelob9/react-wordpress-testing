...
This test is almost identical. One school of thought says one assertion per unit, that way you know exactly what a failure indicates. This is following that rule. Because the first argument of `it()` is a description of the test, it makes reading test results really nice.
